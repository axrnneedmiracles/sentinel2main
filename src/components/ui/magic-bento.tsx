...
const cardData = [
  {
    ...
    description: 'Scan images to detect if they are AI-generated or manipulated.',
    label: 'New'
  },
  {
    id: 'community',
  ...
  },
  {
    ...
    description: 'Upload an image to find and scan links.',
    label: 'Utility'
  },
  {
    id: 'pro',
    color: '#060010',
    title: 'Go Pro',
    description: 'Unlock advanced features like Voice Analysis and Identity Monitoring.',
    label: 'Premium'
  }
];
...
type View = 'home' | 'history' | 'community' | 'about' | 'pro' | 'screenshot' | 'fake-image-detector';
...
const MagicBento = ({
  ...
  const handleCardClick = (id: string) => {
    if(id === 'history' || id === 'community' || id === 'pro' || id === 'screenshot' || id === 'fake-image-detector') {
