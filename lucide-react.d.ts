...
// You can regenerate this file by running `npx lucide-codegen@latest`.
/* eslint-disable */

import type { SVGProps } from 'react';

export type Icon = (props: SVGProps<SVGSVGElement> & {
  size?: number | string;
...
export declare const createLucideIcon: (iconName: string, iconNode: [string, any][]) => Icon;
